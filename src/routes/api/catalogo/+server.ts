...
// search. The browser fetches this once (lazily, on first opening the search), builds
// a client-side Fuse index from it, and matches locally — so keystrokes never hit the
// server. This endpoint deliberately does no matching; it only assembles the index.
//
